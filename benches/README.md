...
generic Jet signature recognition, Jet 3 page-geometry arithmetic, and bounded
complete-page reads without adding benchmark dependencies to the production
workspace.
...
limits; the generated bytes have no page semantics.
...
only and provide no page-validation or compatibility evidence. Those remain
