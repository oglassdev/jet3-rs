...
page-geometry arithmetic, bounded complete-page reads, and fixed-size
commit-region reads without adding benchmark dependencies to the production
workspace.
...
only and provide no page-validation or compatibility evidence. Successful
