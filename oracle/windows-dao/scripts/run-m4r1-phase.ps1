...
$script:M4ExecutedSources = @(
    ...
    "oracle/windows-dao/scripts/m4r1_contract.py", "oracle/windows-dao/scripts/m4r1_records.py",
    "oracle/windows-dao/scripts/m4r1_bundle.py", "oracle/windows-dao/scripts/m4r1_analysis.py",
    "oracle/windows-dao/scripts/m4r1_campaign.py", "oracle/windows-dao/scripts/m4r1_spec.py",
    "oracle/windows-dao/scripts/m4r1_phase.py", "oracle/windows-dao/scripts/m4r1_snapshot.py",
...
try {
    ...
    . (Join-Path $sourceRepository "oracle/windows-dao/scripts/m4r1/M4R1.Artifacts.ps1")
