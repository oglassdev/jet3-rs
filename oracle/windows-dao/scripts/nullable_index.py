...
PLAN = ROOT / 'oracle/windows-dao/acquisition/nullable-index.plan.json'
SCRIPT = 'oracle/windows-dao/scripts/nullable_index.ps1'
...
def dispatch(args):
    ...
    shutil.copyfile(PLAN, inbox / 'nullable-index.plan.json')
    for arm in ARMS:
