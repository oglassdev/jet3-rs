...
function Invoke-M4Campaign {
    ...
    $planPath = Join-Path $repository (
        ...
        "m4-header-discriminator.plan.json"
    )
    $contractPath = Join-Path $repository (
        "oracle/windows-dao/scripts/m4_contract.py"
    )
    $workerPath = Join-Path $repository (
        "oracle/windows-dao/scripts/run-m4-phase.ps1"
    )
    $executedSources = @(
        "oracle/windows-dao/scripts/run-m4-controlled.ps1",
        "oracle/windows-dao/scripts/run-m4-phase.ps1",
        "oracle/windows-dao/scripts/m4_contract.py",
        "oracle/windows-dao/scripts/m4_records.py",
        "oracle/windows-dao/scripts/m4_bundle.py",
        "oracle/windows-dao/scripts/m4_campaign.py",
        "oracle/windows-dao/scripts/m4_spec.py",
        "oracle/windows-dao/scripts/m4_phase.py",
        "oracle/windows-dao/scripts/m4_snapshot.py",
        "oracle/windows-dao/scripts/m4_analysis.py",
        "oracle/windows-dao/scripts/m4/M4.Controller.ps1",
        "oracle/windows-dao/scripts/m4/M4.ControllerRuntime.ps1",
        "oracle/windows-dao/scripts/m4/M4.Bundle.ps1",
        ...
        "oracle/windows-dao/experiments/m4/plan.schema.json",
        "oracle/windows-dao/experiments/m4/invocation.schema.json",
        "oracle/windows-dao/experiments/m4/worker-result.schema.json",
        "oracle/windows-dao/experiments/m4/operation-log.schema.json",
        "oracle/windows-dao/experiments/m4/snapshot.schema.json",
        "oracle/windows-dao/experiments/m4/clone-log.schema.json",
        "oracle/windows-dao/experiments/m4/sample-record.schema.json",
        "oracle/windows-dao/experiments/m4/analysis-report.schema.json",
        "oracle/windows-dao/experiments/m4/bundle-manifest.schema.json",
    ...
    try {
        ...
        if ($completedSamples -ne 36 -or $entries.Count -ne 506) {
