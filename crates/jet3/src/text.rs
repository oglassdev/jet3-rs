...
pub enum TextCodePage {
    ...
    Windows1252,
    /// Windows Greek code page 1253 (SRC-0027).
    Windows1253,
}
...
pub(crate) fn mapped_character(code_page: TextCodePage, byte: u8) -> Option<char> {
    ...
    let scalar = match code_page {
        ...
        TextCodePage::Windows1253 => CP1253[index],
    };
    (scalar != UNDEFINED)
        .then_some(scalar)
...
// SRC-0027: Microsoft CP1253 table 2.01; zero denotes an undefined byte.
const CP1253: [u32; 128] = [
