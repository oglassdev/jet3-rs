...
use super::*;
use crate::column_properties::CreationProperties;
use crate::property_blob::PropertyBlob;
use crate::schema_column_options::{PropertyEdit, apply};
use crate::{PropertyChange, TableValidation};
...
fn appended_columns_reproduce_native_placement() -> TestResult {
    ...
    assert_eq!(
        crate::schema_properties::add(&seed, column, &mut budget())?,
        hex(
    ...
    assert_eq!(
        crate::schema_properties::add(&[], column, &mut budget())?,
        hex(
