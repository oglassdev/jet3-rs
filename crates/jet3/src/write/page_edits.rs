...
pub(super) struct Change {
    ...
    pub(super) before: [u8; PAGE_BYTES],
    pub(super) after: PageImage,
}
...
impl PageEdits {
    ...
    pub(super) fn finish_maps(
        ...
        crate::alloc::mutation_map_guard::validate(database, &self.maps, budget)?;
        ...
        HE: StdError + Send + Sync + 'static,
    {
        ...
        crate::write::update_pages::publish_changes_with_appends(
            path,
            source,
            &changes,
            &self.append,
