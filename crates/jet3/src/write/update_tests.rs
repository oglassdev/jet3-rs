...
impl Fixture {
    ...
    pub(super) fn locator(&self, slot: u8) -> Result<RowLocator, Box<dyn StdError>> {
    ...
    pub(super) fn assert_only_original(&self) -> TestResult {
...
pub(super) fn simple() -> Result<Fixture, Box<dyn StdError>> {
    Fixture::new(
        &[
...
fn relationship_catalog_cases(fixture: Fixture, column: ColumnOrdinal) -> TestResult {
    ...
    let directory =
        crate::format::data_page_directory::DataPageDirectory::validate(&map_page, &mut b)
