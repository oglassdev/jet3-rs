...
impl<S: ReadAt> DatabaseReader<S> {
    ...
    pub fn validate(
        ...
        let mut properties =
            crate::properties::values::Properties::load(self, catalog_root, &roots, budget)
            ...
            let result = self
                ...
                .and_then(|definition| {
                    ...
                    let options = if expected == TableDefinitionKind::User {
                        ...
                        crate::properties::reader::PropertyOptions::default()
                    };
                    validate_table(
                        self,
                        &definition,
        ...
        let relationships = crate::relationship::catalog::validate(self, budget)
...
fn validate_table<S: ReadAt>(
    ...
    options: &[crate::properties::reader::ColumnOptions; 255],
    ...
    crate::row::mutation_graph::RowGraph::load(database, definition, None, budget).map_err(
