...
use crate::{
    ByteCount, ColumnPhysicalType, Error, RawField, ResourceBudget, RowLocator,
    format::text::{DecodedText, TextCodePage, TextError, decode_text},
    long_value::reader::{LongValue, LongValueError, LongValueKind},
};

/// A Currency value stored as an integer scaled by exactly 10,000.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct CurrencyValue {
    pub(super) scaled: i64,
}
