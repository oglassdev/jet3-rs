...
pub(super) struct PlannedCreate<'a> {
    spec: &'a TableSpec<'a>,
    pub(super) plan: TableSchemaPlan,
    ...
    pub(super) properties: Option<crate::properties::column::CreationProperties>,
}
...
impl<'a> PlannedCreate<'a> {
    ...
    pub(super) fn new_with_relationships(
        ...
        let mut replaced = [false; crate::create::schema_plan::MAX_OBSERVED_INDEXES];
        let mut names = Vec::new();
        crate::format::resource::reserve(&mut names, relations.len(), budget)?;
        ...
        crate::format::resource::reserve(&mut relationships, relations.len(), budget)?;
    ...
    fn definition_pages(
        &self,
        budget: &mut ResourceBudget,
    ) -> Result<super::definition_pages::DefinitionPages, ComposeError> {
        let mut pages =
            super::definition_pages::DefinitionPages::new(self.plan.definition_len(), budget)?;
    ...
    fn encode_definition(
        ...
        for &index in &self.relationships {
            ...
            if !*flag && generated {
                ...
                *flag = true;
                ...
                crate::format::resource::reserve(&mut logical, 1, budget)?;
                logical.push(index);
            }
        }
        ...
        for index in &self.relationships {
            ...
            {
                crate::definition::table_writer::set_initial_foreign_count(
                    output,
    ...
    fn map_page_at(
        ...
        use crate::create::schema_plan::MAP_ROWS_PER_PAGE;
...
fn sort_logical_indexes(
    ...
    use crate::catalog::name_key::NameKey;
